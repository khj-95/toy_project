...
public class User {
	...
	//2. 자바빈 패턴
	// getter/setter
	// 단점 : public 메서드인 setter를 통해 속성을 초기화 하기 때문에, 변경불가능한 객체(immutable)을 만들 수 없다.
	...
	// 생성될 User객체의 속성을 초기화하기위한 값을 전달 받아, 해당 값으로 속성을 초기화하고 User 인스턴스를 반환할 inner Class
